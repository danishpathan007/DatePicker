...
@objc enum SDatePickerStyle: Int {
...
@objc open class Picker: NSObject {
    ...
    */
    ...
    private class func controller(title: String? = nil,
                          ...
                          dataArray:Array<String> = [],
                          selectedIndex: Int? = nil,
                          type: SPickerType = .date,
                          style: SDatePickerStyle = .Wheel) -> RPickerController? {
        
        
        if let cc = UIWindow.currentController {
            if SPicker.sharedInstance.isPresented == false {
                SPicker.sharedInstance.isPresented = true
                ...
                vc.onWillDismiss = {
                    SPicker.sharedInstance.isPresented = false
                }
...
class RPickerController: UIViewController {
    ...
    var datePickerStyle: SDatePickerStyle = .Wheel //Only for iOS 14 and above
    var pickerType: SPickerType = .date
